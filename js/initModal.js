function initModal() {
  ...
  // Banner "Riprendi partita" se esiste un salvataggio
...
<div><div class="mname">${mt.label}</div><div class="mdesc">${mt.desc}</div></div>`;
    ...
    const updateSlot = (slot, cls) => {
      ...
      slot.innerHTML = `<div class="slot-badge" style="background:${def.color}">${def.symbol}</div>
